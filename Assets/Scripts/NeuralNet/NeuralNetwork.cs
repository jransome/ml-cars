...
namespace RansomeCorp.NeuralNet
{
    ...
    {
        public readonly List<List<NeuronGene>> Layers;
                ...
                .Select((int nNeurons, int index) =>
                    {
                        ...
                        return new int[nNeurons].Select((_) => new NeuronGene(inputsPerNeuron)).ToList();
                    })
                .ToList();
        }
        ...
        private List<double> FeedForward(List<double> inputs, List<List<NeuronGene>> remainingLayers)
        {
            List<double> outputs = remainingLayers
                .First()
                .Select((neuronGene) => Neuron.Compute(inputs, neuronGene))
                .ToList();
